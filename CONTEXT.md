...
> 현재 상태(2026-08-21): 조회·설정 API, 프론트 목록·상세·키워드 설정·사이드바 출처 설정, 복수 출처 수집기가 구현돼 있다. 현재 수집 출처 목록은 `docs/05-collector-design.md`를 따른다. 교차 출처 dedup·Redis·별도 worker·인증은 아직 없다.
>
