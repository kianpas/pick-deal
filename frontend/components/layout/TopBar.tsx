...
export function TopBar() {
  return (
    <header className="sticky top-0 z-30 grid grid-cols-[1fr_auto] items-center gap-x-3 gap-y-2 border-b border-border bg-bg/85 px-4 py-2 backdrop-blur md:flex md:min-h-16 md:px-6">
